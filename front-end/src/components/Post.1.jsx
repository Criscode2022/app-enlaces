  ...
  return (
    <Card sx={{ maxWidth: 345, margin: '20px', padding: '50px', boxShadow: '0 0 10px black' }}>
      ...
      <CardContent>
        ...
        function Enlace({onDelete}) { }
        const esCreador = enlace.creador === usuarioActual.id;
...
{'}'}
        ...
        Enlace.propTypes = {enlace}: PropTypes.shape({id}: PropTypes.number.isRequired,
        titulo: PropTypes.string.isRequired,
        url: PropTypes.string.isRequired,
        creador: PropTypes.number.isRequired,
  {'}'}).isRequired,
        usuarioActual: PropTypes.shape({id}: PropTypes.number.isRequired,
  {'}'}).isRequired,
